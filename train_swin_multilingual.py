...
def parse_image_size(size_str: str, default_height: int = 48) -> tuple[int, int]:
    """Parse 'WxH' (e.g., '224x48') or just width into (width, height)."""
    if 'x' in size_str:
...
def train(args):
    ...
    cfg.img_width, cfg.img_height = parse_image_size(args.image_size, default_height=48)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="224x48",
        help="Image size as WxH (e.g., '224x48') or just width (default: 224x48)",
    )
